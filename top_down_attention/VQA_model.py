...
class QuestionEncoder(nn.Module):
    ...
    def forward(self, question_tokens):
        ...
        x = self.embedding(question_tokens)  # (batch_size, 14, 300)
...
if __name__ == "__main__":
    ...
    # fake data
    k = 100 # number of feature regions
    question_tokens = torch.randn(batch_size * 100, 14).int() # num_tokens: 14
    image_features = torch.randn(batch_size * 100, k, 2048)
    target = torch.randn(batch_size * 100, answer_vocab_size)
