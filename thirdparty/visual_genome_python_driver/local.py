...
def AddAttrsToSceneGraphs(dataDir='data/visualgenome/'):
  attr_data = json.load(open(os.path.join(dataDir, 'annotations/attributes.json')))
  with open(os.path.join(dataDir, 'annotations/scene_graphs.json')) as f:
  ...
  with open(os.path.join(dataDir, 'annotations/scene_graphs.json'), 'w') as f:
